...
const TeacherUploadQuestionBank: React.FC = () => {
        ...
        <div className="space-y-4">
            <div className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 rounded-2xl p-6 shadow-sm border border-indigo-100 flex justify-between items-start mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-semibold text-slate-800 leading-tight truncate max-w-[180px]" title={pdf.original_filename}>
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div>
                        ...
                        <p className="text-sm text-slate-600 mt-1">
                            Upload Question Bank PDFs and manage them from your workspace.
                        </p>
                    </div>
                    ...
                    <button
                        ...
                        className="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-xl font-medium transition-colors flex items-center gap-2 disabled:opacity-50 shadow"
                    >
            ...
            <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 flex flex-col md:flex-row items-center justify-between gap-5 relative overflow-hidden group">
                ...
                <div className="relative w-full md:w-auto flex-1 max-w-md">
                    <label className="text-sm font-semibold text-slate-700 mb-1.5 block">{isCorporate ? 'Location Selection' : 'Grade Selection'}</label>
                    <select
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative min-h-[400px]">
                <DataTable
                    ...
                    emptyMessage={selectedGradeId === '' ? "Select a grade to view materials." : "No Question Bank PDFs found for this grade."}
                />
...
export default TeacherUploadQuestionBank;
