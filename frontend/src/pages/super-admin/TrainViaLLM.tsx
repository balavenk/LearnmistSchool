        ...
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 rounded-2xl p-6 shadow-sm border border-indigo-100 mb-6 ">
                <div className="flex items-center gap-4 mb-2">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-2">Train Via LLM</h1>
                        <p className="text-slate-600 text-md mt-1">Manage and train LLM with uploaded materials</p>
                    </div>
                </div>
                <div className="mt-6 grid grid-cols-3 gap-4">
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                        <div className="text-slate-600 text-sm font-medium">Total Files</div>
                        <div className="text-2xl font-bold mt-1">{files.length}</div>
                    </div>
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                        <div className="text-slate-600 text-sm font-medium">Not Trained</div>
                        <div className="text-2xl font-bold mt-1">
                            {files.filter(f => f.file_status === 'Uploaded' || f.file_status === 'Skipped' || f.file_status === 'Processing').length}
                        </div>
                    </div>
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                        <div className="text-slate-600 text-sm font-medium">Trained</div>
