    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-slate-900">School Types</h1>
                    <p className="text-slate-500 mt-1">Manage school level types by country.</p>
                </div>
                <button
                ...
                >
                    <span className="mr-2 text-xl leading-none">+</span> Add School Type
                </button>
            </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl p-6">
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-xl font-bold text-slate-900">{modalMode === 'add' ? 'Add School Type' : 'Edit School Type'}</h2>
