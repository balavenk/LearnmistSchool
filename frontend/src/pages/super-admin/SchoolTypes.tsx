...
const SchoolTypes: React.FC = () => {
    ...
    // DataTable Columns
    const columns = useMemo<ColumnDef<SchoolType>[]>(
        () => [
            {
                accessorKey: 'name',
                ...
                cell: ({ row }) => (
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-slate-900 text-lg">{row.original.name}</span>
                    </div>
                ),
            },
            {
                ...
                cell: ({ row }) => (
                    <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold bg-blue-100 text-blue-700 border border-blue-200">
                        ...
                        {getCountryName(row.original.country_id)}
                    </span>
                ),
            },
            {
