...
const StudentGrades: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-1">My Grades</h1>
                <p className="text-slate-600 mt-1">Track your progress across all subjects.</p>
            </div>
